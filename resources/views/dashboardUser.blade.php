    ...
    <div class="col-lg-7">
        <div class="container">
            ...
            <ul class="list-unstyled li-space-lg indent">
                ...
                <img src="{{ asset ('https://source.unsplash.com/1200x1200?money') }}" width="20px" height="20px"
                    style="margin-right: 0.75rem; margin-left: 1rem;"><b>Dana/OVO :
                    {{ $conf->no_telpon }} a.n
                    {{ $conf->name }}</b><br>
                @endforeach
                <br>
