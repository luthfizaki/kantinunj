...
<div class="col-lg-8">
    ...
    @csrf
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error ('product_name') is-invalid @enderror" id="name" placeholder="" name="product_name" required value="{{ old('product_name', $product['amount']) }}">
            @error ('product_name')
